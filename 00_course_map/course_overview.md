# YES FTC Robotics Course Overview
...
Most sessions should follow this recurring instructional rhythm:

1. Background information
2. Design or strategy menu
3. Student-led discussion
4. Team decision
5. Build, fabricate, program, or test
6. Engineering notebook evidence/reflection

The existing files already support this rhythm through background readings, design menus, student-led discussion prompts, decision tables, portfolio deliverables, and reflections.
...
## Working Source-of-Truth Rule

Markdown files should be treated as editable source files. PDFs should be treated as generated print/export files unless a future note says otherwise. See `docs/source_file_policy.md` for the working policy.
