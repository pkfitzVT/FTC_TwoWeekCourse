# Session 7: Build Drivetrain/Chassis
...
TODO: Prepare tools, frame parts, brackets, fasteners, motors, wheels, batteries for fit checks, safety glasses, and team storage areas.

## Opening Move

TODO: Ask students which chassis design choice they need to protect as they begin building.

## Background / Mini-Lesson

Use the chassis build checklist and mounting motors/wheels readings to introduce build vocabulary, tool vocabulary, motor mounting, wheel security, alignment, clearance, and access.
...
Teams assemble the chassis or drivetrain, checking motor and wheel mounting before powered testing.
...
TODO: Teams identify one build choice that worked and one part that needs checking before powered testing.

## Cleanup

TODO: Return tools, secure loose fasteners, label team builds, and store batteries safely.

## Teacher Notes

TODO: Track teams needing mechanical support, missing parts, alignment help, or build simplification.
