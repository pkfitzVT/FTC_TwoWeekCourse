...
Teams connect controller choices to robot behavior, update the frame/drivetrain subsystem cycle, and plan the first drivetrain test.

## Build / Program / Test Time

Teams program/configure basic TeleOp movement and run controlled drivetrain tests.

## Engineering Notebook Evidence

Teams record observed behavior, code/config change, subsystem test result, and result for each meaningful test.
