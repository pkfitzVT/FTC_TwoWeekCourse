...
TODO: Prepare team assignments, name/norm menu access, the Team Strategy Guide template, and a way for teams to record final agreements.
...
Teams complete name and norm decision tables, including what they chose and what trade-offs they accepted. Teams also add the started Team Strategy Guide so it can be revisited before chassis, mechanism, programming, and driver-practice decisions.
