...
| Controller Mapping / Driver Controls | Drive-team role plan and backups | During Session 8 drive reliability challenge and later practice runs | `02_student_materials/guides/day4_session8_drive_reliability_round_robin_challenge.md`; Controller Mapping SLD; Drive Power / Motor Tuning SLD; engineering notebook | Timed runs; penalties; driver/operator notes; communication quality; accuracy under pressure; ability to recover from mistakes; fairness and growth needs | Role decision record with primary driver, primary operator if used, backups, rotation plan, and practice goals | Driver practice; TeleOp routine; match readiness; final presentation evidence |
