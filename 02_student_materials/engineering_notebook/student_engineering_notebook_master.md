...
- Notebook evidence required: Chassis readiness checklist, issue/fix list, D-pad vs joystick trial data, driver/operator notes, Controller Mapping SLD work product, initial drive power/speed setting, slow mode decision if applicable, and next test.
