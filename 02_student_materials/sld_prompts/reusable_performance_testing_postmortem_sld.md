# Performance Testing Postmortem SLD

## Session / Course Phase

Reusable SLD for post-test and post-match reflection after performance tests, driving challenges, subsystem tests, autonomous challenges, practice matches, qualification rounds, between-round repair decisions, and whole-robot integration tests.
...
By the end of this SLD, your team should complete a Performance Postmortem Record that includes:
...
- result
- evidence used
- human operation notes
- mechanical system notes
- software/control notes
- strategy/communication notes
...
Categories may overlap, but choose one main issue category for the next revision.
...
Add the Performance Postmortem Record to the engineering portfolio.
...
During the next test or match discussion, our team should improve by:

- using evidence instead of blame
- naming the main issue category clearly
- choosing one or two changes, not everything at once
- assigning responsibility clearly
- retesting the change
- recording what changed and what happened next
